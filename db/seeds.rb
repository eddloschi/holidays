...
Holiday.create(name: 'Mother\'s Day', schedule: schedule.to_hash, recurrent: true)
Holiday.create(name: 'Labor Day', schedule: {month_of_year: 5, day_of_month: 1}, recurrent: false)
